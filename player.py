...
class Player:
	def __init__(self,name,game):
		...
		self.weapon = 0 # if the player currently has a weapon

	def show_inv(self): # displays inventory
	...
	def battle_ui(self): # displays battle interface
		print(self.name)
		print("HP: {}".format(self.hp))
		print("Attack: {}".format(self.attack))
	...
	def get_damage(self): # returns the damage the player deals
